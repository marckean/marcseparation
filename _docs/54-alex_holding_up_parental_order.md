...
You might remember [this](/marcseparation/charlie/#charlie--covid19) when Charlie was diagnosed positive with Covid19, where Alex didn't seem to want to accept the NSW public health orders and accept that Charlie was isolating with me. See [the link immediately above](/marcseparation/charlie/#charlie--covid19) for the details, however Alex now wanted to have a clause written in the federal court parenting order where and if the kids get Covid again, then they are allowed to move from one home to another which directly contradicts the NSW public health orders.
